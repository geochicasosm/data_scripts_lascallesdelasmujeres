...
function initWomenDic(){
    ...
    const lr = new LineByLineReader(path.join(__dirname, `../namesDB/list_mujeres.csv`), { encoding: 'utf8', skipEmptyLines: true });
...
function initMenDic(){
    ...
    const lr = new LineByLineReader(path.join(__dirname, `../namesDB/list_hombres.csv`), { encoding: 'utf8', skipEmptyLines: true });
...
function initReadFile(stream){
    ...
    const lr = new LineByLineReader(path.join(__dirname, `../data/${folder}/list.csv`), { encoding: 'utf8', skipEmptyLines: true });
